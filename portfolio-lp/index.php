...
<aside id="mainimg">
<img src="<?php echo get_theme_file_uri('/images/1.jpg'); ?>" alt="">
</aside>
...
<div id="contents">
    ...
    <div id="main">
        ...
        <section>
            ...
            <h3>利用規約のご案内</h3>
            <p>このテンプレートは、<a href="http://template-party.com/">Template Party</a>にて無料配布している『文房具店(ビジネス)向け 無料ホームページテンプレート tp_biz50』です。必ずダウンロード先のサイトの<a href="http://template-party.com/read.html">利用規約</a>をご一読の上でご利用下さい。</p>
            ...
            <p><strong class="color1">■下部の著作を外したい場合は</strong><br>
                <a href="http://template-party.com/">Template-Party</a>の<a href="http://template-party.com/member.html">ライセンス契約</a>を行う事でHP下部の著作を外す事ができます。
            </p>
